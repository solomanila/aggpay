...
<template>
  <div class="bookkeeping-view">
    ...
    <section class="panel entries-table">
      <header>
        <p class="eyebrow">记账流水</p>
        <h3>最新记录</h3>
      </header>
      <table>
        <thead>
...
.gradient {
  background: linear-gradient(135deg, rgba(77, 95, 255, 0.65), rgba(11, 16, 32, 0.95));
