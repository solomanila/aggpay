...
public class UserVipServiceImpl implements UserVipService {
    ...
    @Override
    @Cacheable(value = "user:vip", key = "#userId", unless = "#result == null")
    ...
    @Override
    @Transactional
    @CacheEvict(value = {"user:vip", "user:info"}, key = "#request.userId")
